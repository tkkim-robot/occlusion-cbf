...
class CBFInputBoundsTests(unittest.TestCase):
    ...
    def test_base_controller_defaults_to_reverse_capable(self):
        controller = CBFQP(object(), dict(self.ROBOT_SPEC), num_obs=1)
        self._assert_reverse_capable(controller)

    def test_runtime_controller_defaults_to_reverse_capable(self):
        controller = LocalCBFQP(object(), dict(self.ROBOT_SPEC), num_obs=1)
        self._assert_reverse_capable(controller)
    ...
    def test_control_tree_input_bounds_honor_reverse_capable_plan_floor(self):
    ...
    def test_mpc_baselines_honor_reverse_capable_robot_bound(self):
