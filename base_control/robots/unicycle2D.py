...
from base_control.robots.moving_circle import dynamic_agent_barrier as _moving_circle_barrier
...
class Unicycle2D:
    ...
    def dynamic_agent_barrier(self, X, obs, robot_radius, beta=1.01):
