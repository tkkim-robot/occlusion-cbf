...
OUT=Path('debug_logs/uni_idx2_rev_allowed_vmin005_top3_k40_diagnostic_20260618')
...
runtime=crowd1._prepare_crowd_runtime(
    ...
    robot_spec_overrides={'v_min': -0.05},
